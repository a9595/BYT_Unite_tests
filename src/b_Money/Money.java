...
public class Money implements Comparable {
    ...
    public Boolean equals(Money other) {
        if (other.getAmount() == this.getAmount()
                && other.getCurrency().equals(this))
            return true;
        else return false;
    }
     ...
     */
    public Money negate() {
        Money negatedMoney = new Money(this.amount - (this.amount * 2), this.getCurrency());
        return negatedMoney;
    ...
    public int compareTo(Object other) {
        Money paramMoney = (Money) other;
        if (this.getAmount() == paramMoney.getAmount())
            return 0;
        else if (this.getAmount() < paramMoney.getAmount())
            return -1;
        else
            return 1;
    }
